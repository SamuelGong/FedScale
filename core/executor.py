...
class Executor(object):
    ...
    def setup_env(self):
        ...
        if self.args.use_cuda:
            if self.device == None:
                ...
                # otherwise the default one is cuda:0 and some intermediate results would go there
    ...
    def training_handler(self, clientId, conf):
        ...
        if conf.personalized == "ditto":
            ...
            logging.info(f"require_grad {client_model.requires_grad} {local_model.requires_grad}")
