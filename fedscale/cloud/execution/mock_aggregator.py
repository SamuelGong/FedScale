...
from mock_fl_aggregator_libs import *
from mock_argParser import args
...
class Aggregator(object):
    ...
    def run(self):
        ...
        size_in_bytes = sys.getsizeof(pickle.dumps(self.model))
        self.model_update_size = size_in_bytes / 1024.0 * 8. # kbits
        logging.info(f"JZF model_update_size={size_in_bytes / 1024 / 1024} MB")
